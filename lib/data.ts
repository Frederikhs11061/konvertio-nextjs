...
export const services: Service[] = [
  {
    ...
    description: 'Professionelle static creatives der stopper scroll og driver konverteringer på Facebook, Instagram og andre sociale medier.',
    shortDescription: 'Static ads der stopper scroll og driver salg på sociale medier.',
    icon: 'Target',
    features: [
      'Research-baseret tilgang',
      'Flere pain point vinkler',
      'Mobil-optimerede designs',
      'Hurtig levering',
      'Revisions inkluderet',
    ],
    benefits: [
      'Højere ROAS på dine annoncer',
      'Flere konverteringer',
      'Lavere CPC',
      'Bedre ad relevance score',
    ],
    packages: [
      {
        name: 'Pakke 1 – Mini test',
        price: '1.995 kr.',
        description: 'Perfekt til at komme i gang med static ads og teste hvad der virker for din målgruppe.',
        features: [
          '5 static creatives',
          'Research før der genereres både statics og long-form copy',
          '1 revision',
          'Levering inden for 5 hverdage',
        ],
      },
      {
        name: 'Pakke 2 – Udvidet test-batch',
        price: '3.495 kr.',
        description: 'Ideel når du vil teste flere pain points og vinkler for at finde de vindende koncepter.',
        features: [
          '10 static creatives',
          'Research + flere pain-vinkler/versionering',
          '2 revisioner',
